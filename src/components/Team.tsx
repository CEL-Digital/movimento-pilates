    ...
    return (
        ...
        <div className="mx-auto max-w-6xl px-5">
          ...
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {equipe.map((m) => (
              <article key={m.nome} className="overflow-hidden rounded-3xl border border-border bg-card">
                <img
                  src={m.img}
            ...
            <div className="flex flex-col justify-center rounded-3xl bg-secondary/70 p-8">
              ...
              <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
                Nossos instrutores são selecionados pelo cuidado com o aluno e pela
                formação acadêmica. Venha conhecer o studio e o
                profissional que vai acompanhar o seu treino.
              </p>
